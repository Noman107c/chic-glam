...
export const mockRoles: Role[] = [
  ...
  },
  {
    id: '5',
    name: 'Supervisor',
    description: 'Supervisor with staff monitoring and daily operations oversight',
    permissions: ['users.read', 'attendance.read', 'services.read', 'booking.read', 'payments.read'],
    createdAt: new Date('2024-01-01'),
  },
  {
    id: '6',
    name: 'Cashier',
    description: 'Cashier with handling of payments and sales transactions',
    permissions: ['payments.create', 'payments.read', 'booking.read'],
    createdAt: new Date('2024-01-01'),
  },
  {
    id: '7',
    name: 'Cleaner',
    description: 'Cleaner with facility cleaning and maintenance',
